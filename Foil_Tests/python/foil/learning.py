...
def foil(
    ...
    print('esempi positivi totali:')
    print(len(positives))
    print('esempi negativi totali:')
    print(len(negatives))
    print()
    ...
    print(str(target) + ' :- ')
    print()
    print('esempi positivi soddisfatti: ')
    print(len(positives))
    print('esempi negativi soddisfatti: ')
    print(len(negatives))
    print()
    print('_____________________________________________')
    print()
    ...
    while positives:
        ...
        if positives:
            print()
            print('esempi positivi già soddisfatti:')
            print(hypothesis.positives)
            print('esempi positivi non ancora soddisfatti:')
            print(positives)
