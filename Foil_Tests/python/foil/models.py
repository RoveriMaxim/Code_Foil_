...
from visitor import FoilVisitor
from unification import Derivation
from unification import is_ground
from unification import is_variable
from unification import normalize
from unification import simplify
from unification import Substitution
from unification import Term
from unification import unify
from unification import Value
from unification import Variable
...
class Program:
    ...
    def resolve(self, query: Literal) -> Optional[Derivation]:
        ...
        from unification import resolve

        return resolve(self, query)

    def ground(self) -> List[Literal]:
        from rete import ground
